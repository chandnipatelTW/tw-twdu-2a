...
scp ./zookeeper/seed.sh kafka.twdu-2a-qa.training:/tmp/zookeeper-seed.sh
ssh kafka.twdu-2a-qa.training '
set -e
export hdfs_server="emr-master.twdu-2a-qa.training:8020"
export kafka_server="kafka.twdu-2a-qa.training:9092"
export zk_command="zookeeper-shell kafka.twdu-2a-qa.training:2181"
